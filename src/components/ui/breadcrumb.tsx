...
const BreadcrumbSeparator = ({ children, className, ...props }: React.ComponentProps<'li'>) => (
  <li role="presentation" className={cn('px-1 text-muted-foreground', className)} {...props}>
...
const BreadcrumbEllipsis = ({ className, ...props }: React.ComponentProps<'span'>) => (
  <span role="presentation" className={cn('flex h-6 w-6 items-center justify-center', className)} {...props}>
